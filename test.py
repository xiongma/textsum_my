...
# word2vec = NewsW2V().w2v_model
# contents = [['<PAD>', '我的']]
# word2vec.build_vocab(contents, update=True)
# word2vec.train(sentences=contents, epochs=word2vec.epochs, total_examples=word2vec.corpus_count)
# word2vec.save('full_w2v')
# print(word2vec.wv.get_vector('<PAD>'))
